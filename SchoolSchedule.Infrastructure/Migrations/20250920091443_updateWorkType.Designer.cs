...
namespace SchoolSchedule.Infrastructure.Migrations
{
    ...
    [Migration("20250920091443_updateWorkType")]
    partial class updateWorkType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchoolSchedule.Domain.Teacher", b =>
                {
                    ...
                    b.ToTable("Teachers", t =>
                        {
                            t.HasCheckConstraint("CHECK_IF_WORKTYPE_IS_FULLTIME_OR_PARTTIME", "[WorkType] IN ('كلي','جزئي')");
                        });
                });
