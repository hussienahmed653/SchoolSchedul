...
namespace SchoolSchedule.Infrastructure.Migrations
{
    ...
    [Migration("20250919133430_AddJopTitleTable")]
    partial class AddJopTitleTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolSchedule.Domain.JopTitle", b =>
                {
                    b.Property<int>("JopTitleId")
                        .HasColumnType("int");

                    b.Property<Guid>("JopTitleGuid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("NEWID()");

                    b.Property<string>("JopTitleName")
                        .IsRequired()
                        .HasMaxLength(100)
